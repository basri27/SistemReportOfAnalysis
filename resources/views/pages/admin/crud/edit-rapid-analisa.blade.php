    ...
    <div class="row mt-4 mx-4">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <form action="{{ route('update-data-rapid', $analisa->id) }}" method="POST">
                    @method('PATCH')
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="number" step="any" min="0" name="ash" id="ash"
                                    @if ($analisa->iso_id != null) value="{{ $analisa->iso->ash }}" @endif
                                    class="form-control form-control-sm mb-2" disabled>
                            </div>
                            <div class="col-md-3">
                                <label for="" class="mb-1">Total Sulfur(TS-A)</label>
                                <input type="number" step="any" min="0" name="sulfur" id="sulfur"
                                    @if ($analisa->iso_id != null) value="{{ $analisa->iso->sulfur }}" @endif
                                    class="form-control form-control-sm mb-2" disabled>
                            </div>
                        </div>
                    </div>
