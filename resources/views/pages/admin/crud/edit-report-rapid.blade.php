...
@section('title', 'Edit Hasil Analisa (Standard RAPID) | Sistem Report of Analysis')
@section('content')
    ...
    <div class="row mt-4 mx-4">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <form action="{{ route('report-update-rapid', $report->id) }}" method="POST">
                    @method('PATCH')
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="number" step="any" min="0" name="ash" id="ash"
                                    @if ($report->analisa->iso_id != null) value="{{ $report->analisa->iso->ash }}" @endif
                                    class="form-control form-control-sm mb-2" disabled>
                            </div>
                            <div class="col-md-3">
                                <label for="" class="mb-1">Total Sulfur(TS-A)</label>
                                <input type="number" step="any" min="0" name="sulfur" id="sulfur"
                                    @if ($report->analisa->iso_id != null) value="{{ $report->analisa->iso->sulfur }}" @endif
                                    class="form-control form-control-sm mb-2" disabled>
                            </div>
                        </div>
                    </div>
