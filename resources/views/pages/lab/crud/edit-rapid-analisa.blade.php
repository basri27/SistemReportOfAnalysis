    ...
    <div class="row mt-4 mx-4">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <form action="{{ route('update-analisa-rapid', $analisa->id) }}" method="POST">
                    @method('PATCH')
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="number" step="any" min="0" name="ash" id="ash"
                                    @if ($analisa->iso_id != null) value="{{ old('ash', $analisa->iso->ash) }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="any" min="0" name="sulfur" id="sulfur"
                                    @if ($analisa->iso_id != null) value="{{ old('sulfur', $analisa->iso->sulfur) }}"
